...
for f in range(scn.frame_start, scn.frame_end+1):
    fpath = bpy.path.abspath('/home/rnakanishi/git/bahamut-lib/results/80-p2-va2-la2/{:04d}.obj'.format(f))
    ...
    bpy.context.scene.render.filepath = "/home/rnakanishi/Documents/blender/ando/80-p2-va2-la2/{:04d}.jpg".format(f)

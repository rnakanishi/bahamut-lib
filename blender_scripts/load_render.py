...
for f in range(scn.frame_start, scn.frame_end+1):
    fpath = bpy.path.abspath(
        '/home/rnakanishi/git/bahamut-lib/results/test/{:04d}.obj'.format(f))
    ...
    bpy.ops.export_scene.obj(
        filepath=fpath, use_normals=False, use_materials=False, use_selection=True)
    ...
    bpy.context.scene.render.filepath = "/home/rnakanishi/Documents/blender/ando/frames/50_interp/{:04d}.jpg".format(
        f)
